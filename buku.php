<?php
    ...
    $query  = "SELECT * FROM buku ORDER BY 'ID' ASC LIMIT $offset, $rowsPerPage";
    $result = mysql_query($query) or die('Error, query failed'); 
	//jumlah total
	$query1   = "SELECT COUNT(ID) AS numrows FROM buku";
...
<body>
				...
				<table class="table">
					...
					<tbody>
						<tr>
                            ...
                            <td class="text-center"><a href="downloadbuku.php?id=<?php echo $row[0] ?>">Download</a></td>
	...
	<?php
		// how many rows we have in database
			$query   = "SELECT COUNT(judul) AS numrows FROM buku";
			$result  = mysql_query($query) or die('Error, query failed');
