<?php
    ...
    $query  = "SELECT * FROM pengumuman ORDER BY 'id' ASC LIMIT $offset, $rowsPerPage";
    $result = mysql_query($query) or die('Error, query failed'); 
	//jumlah total
	$query1   = "SELECT COUNT(id) AS numrows FROM pengumuman";
...
<body>
				...
				<table class="table">
					...
					?>
						<tr>
							...
							<td><?php echo $hasil['untuk']; ?></td>
							<td><?php echo $hasil['pesan']; ?></td>
							<?php
								echo "<td>".'<a href="deletepengumuman.php?del='.$hasil['id'].'">Delete</a>'."</td>";
							?>
						</tr>
						<?php $no++; } ?>
					</tbody>
	...
	<?php
		// how many rows we have in database
			$query   = "SELECT COUNT(id) AS numrows FROM pengumuman";
			$result  = mysql_query($query) or die('Error, query failed');
