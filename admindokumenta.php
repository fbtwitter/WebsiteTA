<?php
    ...
    $query  = "SELECT nrp, nama, tahunlulus, judulta, fileproposal FROM dokumenta ORDER BY 'nrp' ASC LIMIT $offset, $rowsPerPage";
    $result = mysql_query($query) or die('Error, query failed'); 
	//jumlah total
	$query1   = "SELECT COUNT(nrp) AS numrows FROM dokumenta";
...
<body>
				...
				<table class="table">
					...
					?>
						<tr>
							...
							<td><?php echo $hasil['tahunlulus']; ?></td>
							<td><?php echo $hasil['judulta']; ?></td>
							<td><a href="download.php?id=<?php echo $row['nrp'] ?>">Download</a></td>
	...
	<?php
		// how many rows we have in database
			$query   = "SELECT COUNT(nrp) AS numrows FROM dokumenta";
			$result  = mysql_query($query) or die('Error, query failed');
