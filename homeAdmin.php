<?php
    ...
    $query  = "SELECT nrp, nama, kelas, prodi FROM user ORDER BY 'id' ASC LIMIT $offset, $rowsPerPage";
    $result = mysql_query($query) or die('Error, query failed'); 
	//jumlah total
	$query1   = "SELECT COUNT(nrp) AS numrows FROM user";
...
<body>
	...
	<body class=" section-bg wow fadeInUp">
		<div class="container">
			<div class="formDaftar">
				...
				<div class="judul">
					<h5>
						<strong>Daftar User Tugas Akhir</strong>
					</h5>
				</div> 
				<div class="row">
					...
					<a href="">
						<button type="button" class="btn btn-dark">
							<i class=" fa fa-user"></i> Input Mahasiswa Baru</button>
					</a>
				</div>
				<br>
				<table class="table">
					...
					?>
						<tr>
							...
							<?php
								echo "<td>".'<a href="delete.php?del='.$hasil['nrp'].'">Delete</a>'."</td>";
							?>
						</tr>
						<?php $no++; } ?>
					</tbody>
	...
	<?php
		// how many rows we have in database
			$query   = "SELECT COUNT(nama) AS numrows FROM user";
			$result  = mysql_query($query) or die('Error, query failed');
